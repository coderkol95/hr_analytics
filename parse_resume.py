...
class Resume:
    ...
    def _createPrompt(self):
        ...
        prompt= "Your job is of a Resume Parser. From the resume information given inside the delimiter #,\
                 you shall find out the details such as Name, contact number, email id and other profile links, \
                 phone number, skillsets, past job experience. Once you find them out you need to show them in pointwise manner.\
                 Keep it short and precise. Do not generate anything unnecessary and Do not generate anything on your own that is not in the context"
